...
<tr>
  ...
  <form method="post" name="wps_cancel" action="/goform/WPSRaixCancel" onSubmit="WPSCancel()">
    <td align="center"><input type="submit" value="Cancel" id="wpsCancel" name="wpsCancel"></td>
  </form>
</tr>
</tbody></table>
</td></tr></table>
