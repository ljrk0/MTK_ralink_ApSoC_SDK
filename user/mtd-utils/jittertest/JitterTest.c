 ...
 *
 *  Revision History:
 *  $Id: //WIFI_SOC/release/SDK_4_1_0_0/source/user/mtd-utils/jittertest/JitterTest.c#1 $
 *  $Log: JitterTest.c,v $
...
static const char Version[] = "$Id: //WIFI_SOC/release/SDK_4_1_0_0/source/user/mtd-utils/jittertest/JitterTest.c#1 $";
