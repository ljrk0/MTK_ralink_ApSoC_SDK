#!/bin/sh
#
# "$Id: //WIFI_SOC/release/SDK_4_1_0_0/source/user/samba-3.0.37/packaging/LSB/samba.sh#1 $"
#
...
#
# End of "$Id: //WIFI_SOC/release/SDK_4_1_0_0/source/user/samba-3.0.37/packaging/LSB/samba.sh#1 $".
#
